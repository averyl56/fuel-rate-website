...
function Home() {
    return (
        <div style={{ display: 'flex', justifyContent: 'left', alignItems: 'center', width: '100vw',height: '100vh', position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'orange', padding: '10px', borderRadius: '5px', textAlign: 'center',fontFamily: 'Arial' }}>
                <p style={{ fontSize: '24px',  color: 'black' }}>Welcome to</p>
                <p style={{ fontSize: '24px', color: 'black' }}>Fuel Tracker</p>
                ...
                <p><strong>Please log in to get started!</strong></p>
            </div>
        </div>
    );
}
